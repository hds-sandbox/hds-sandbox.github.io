...
For more details or to repeat the process on your own, you can also visit [this](https://hds-sandbox.github.io/bulk_RNAseq_course/develop/05a_data_analysis_setup.html) website.
...
- To get started with our transcriptomics app, follow the [`UCloud` setup](https://hds-sandbox.github.io/bulk_RNAseq_course/develop/05a_data_analysis_setup.html) guidelines. 
