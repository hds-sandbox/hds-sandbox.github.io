...
## HPC Lab and data management {#sandbox-hpc}
...
- [HPC-Lab](https://hds-sandbox.github.io/HPC-lab/)
...
- [GenomeDK Workshop Resources (AU)](https://hds-sandbox.github.io/GDKworkshops/)
...
Health and administrative data collected through healthcare systems, public registries, and research studies are valuable resources for data science and predictive modelling, including applications such as dynamic risk prediction in healthcare. Because these datasets often contain sensitive personal information, access is typically subject to strict governance and privacy protections. In some cases, curated subsets of data are made available through disease-specific or population-based registries to support research, quality improvement, and methodological development.

- [Dynamic Risk Prediction](https://hds-sandbox.github.io/Dyn_Risk_Pred_Course/)
...
- [Synthetic Data](../datasets/synthdata.qmd) for more information.
