...
| Lev Levitsky                  | Data Scientist                      | Department of Biochemistry and Molecular Biology, SDU|Ole N. Jensen, Veit Schwämmle|
...
We appreciate the contributions of previous team members Jacob Fredegaard Hansen (SDU), José Alejandro Romero Herrera (KU), Conor O'Hare (KU), Sander Boisen Valentin (AAU) and Peter Husen (SDU). A special thanks goes to the former project manager, Jennifer Bartell (KU), who led the project for five years and played a key role in developing many of the ideas and content that have shaped Sandbox into what it is today. Their dedication and vision have made a lasting difference.
